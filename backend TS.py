...
def online(url,lbl,lb1):
    ...
    tt=translator.translate(Disha, dest='pa')
    from docx import Document
    document = Document()
    document.add_heading('Punjabi Wiki Summariser', 0)
    p=document.add_paragraph('The URL')
    p.add_run(url).bold = True
    document.add_paragraph('Punjabi Summary')
    document.add_paragraph(tt.text)
    document.add_paragraph('English Summary')
    document.add_paragraph(Disha)
    document.add_page_break()
    document.save('online.docx')
    
    DD = 'Word Document Created'''
    
    return(lbl.config(text=DD,bg='skyblue',font=("Courier", 20)),lbl.place(x = 250, y = 410, width=850, height=300),lb1.config(text='Summary',bg='skyblue',font=("Courier", 20)),lb1.place(x = 250, y = 380, width=150, height=30))
    #return(lbl.config(text=''+tt,borderwidth=2, relief="solid"),lbl.place(x = 250, y = 410, width=850, height=300),lb1.config(text='Summary',bg='skyblue',font=("Courier", 20)),lb1.place(x = 250, y = 380, width=150, height=30))
